...
public class Maze6 extends JFrame										//DOROTHY
{
	...
	class HoldPanels extends JPanel										//DOROTHY
	{
		...
		class StartPanel extends JPanel implements ActionListener		//DOROTHY
		{
			...
			public void paintComponent(Graphics g)
			{
				...
				//g.drawImage(stickBoy, 0, 0, 100, 100, this);
			}
			...
			class MediumMazePanel extends JPanel implements MouseListener								//DOROTHY
			{
				...
				public void paintComponent(Graphics g)
				{
					...
					if (mTutorial)
					{
						g.setColor(Color.RED);
						g.setFont(new Font("Monospaced", Font.BOLD, 30));
						g.drawString("HINTS",1080,600);
						g.setFont(new Font("Monospaced", Font.BOLD, 50));
						g.drawString("^",1000,580);
						g.drawString("\\",1009,600);
						g.drawString("1",1040,600);
						mTutorial = false;
					}
				}
				public void mouseClicked(MouseEvent e){}
			...
			class HardControlPanel extends JPanel implements ActionListener
			{
				...
				public void actionPerformed(ActionEvent e)
				{
					if (hardEnterAns.getActionCommand().equals("ENTER"))
					{
						...
						else if ((hardXPos == 1250) && (hardYPos == 490) && (text1.getText().equals("3")) && (text2.getText().equals("180")))
						{
							hardXPos = 650;
							hardYPos = 490;
							hMazeP.repaint();
						}
						else if ((hardXPos == 650) && (hardYPos == 490) && (text1.getText().equals("1")) && (text2.getText().equals("90")))
						{
							hardXPos = 650;
							hardYPos = 370;
							vector = true;
						...
						else if ((hardXPos == 250) && (hardYPos == 370) && (text1.getText().equals("2")) && (text2.getText().equals("90")))
						{
							hardXPos = 250;
							hardYPos = 130;
							vector = true;
						...
						else if ((hardXPos == 1050) && (hardYPos == 130) && (text1.getText().equals("1")) && (text2.getText().equals("90")))
						{
							hardXPos = 1050;
							hardYPos = 10;
							vector = false;
